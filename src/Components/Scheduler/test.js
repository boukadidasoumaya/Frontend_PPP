...
//             // Course Dropdown
//             let courseContainer = createElement('div', { className: 'custom-field-container' });

//             let courseLabel = createElement('label', { textContent: 'Course' });
//             courseContainer.appendChild(courseLabel);

//             let courseInputEle = createElement('input', {

//                 className: 'e-field', attrs: { name: 'Course' }

//             });

//             courseContainer.appendChild(courseInputEle);

//             let courseDropDownList = new DropDownList({
//                 // ... (your course data source here)
//                 fields: { text: 'text', value: 'value' },
//                 floatLabelType: 'Always',
//                 placeholder: 'Select Course'
//             });

//             courseDropDownList.appendTo(courseInputEle);
//             row.appendChild(courseContainer);

//             // Professor Dropdown (similar structure as course)
//             let professorContainer = createElement('div', { className: 'custom-field-container' });

//             let professorLabel = createElement('label', { textContent: 'Professor' });
//             professorContainer.appendChild(professorLabel);

//             let professorInputEle = createElement('input', {

//                 className: 'e-field', attrs: { name: 'Professor' }

//             });

//             professorContainer.appendChild(professorInputEle);

//             let professorDropDownList = new DropDownList({
//                 // ... (your professor data source here)
//                 fields: { text: 'text', value: 'value' },
//                 floatLabelType: 'Always',
//                 placeholder: 'Select Professor'
//             });

//             professorDropDownList.appendTo(professorInputEle);
//             row.appendChild(professorContainer);

//             // Major Dropdown (similar structure as course)
//             let majorContainer = createElement('div', { className: 'custom-field-container' });

//             let majorLabel = createElement('label', { textContent: 'Classroom' });
//             majorContainer.appendChild(majorLabel);

//             let majorInputEle = createElement('input', {

//                 className: 'e-field', attrs: { name: 'Classroom' }

//             });

//             majorContainer.appendChild(majorInputEle);

//             let majorDropDownList = new DropDownList({
//                 // ... (your major data source here)
//                 fields: { text: 'text', value: 'value' },
//                 floatLabelType: 'Always',
//                 placeholder: 'Select Classroom'
//             });

//             majorDropDownList.appendTo(majorInputEle);
//             row.appendChild(majorContainer);

//             // Hide the title field
//             let titleElement = formElement.querySelector('[name="Subject"]');
//             if (titleElement) {
//                 titleElement.parentNode.parentNode.style.display = 'none';
//             }
//              let locationElement = formElement.querySelector('.e-location-container');
//           if (locationElement) {
//               locationElement.style.display = 'none';
//           }
//           let dayElement = formElement.querySelector('.e-all-day-time-zone-row');
//           if (dayElement) {
//               dayElement.style.display = 'none';
//           }
//           let repeatElement = formElement.querySelector('.e-recurrenceeditor');
//           if (repeatElement) {
//               repeatElement.style.display = 'none';
//           }
//           let desciptionElement = formElement.querySelector('.e-description-row');
//           if (desciptionElement) {
//               desciptionElement.style.display = 'none';
//           }
//         }
//     }
// };
...
//                   <ScheduleComponent currentView={currentView} width='100%' height='650px' selectedDate={new Date(2021, 1, 15)} ref={scheduleObj} eventSettings={{ dataSource: data, fields: fields }}  editorHeaderTemplate={editorHeaderTemplate} popupOpen={onPopupOpen} actionBegin={onActionBegin}  eventRendered={onEventRendered}
...
registerLicense(
  "Ngo9BigBOggjHTQxAR8/V1NBaF5cXmZCekxwWmFZfVpgdVRMYF5bRXBPMyBoS35RckVgWn9fcXRXR2ZUVUV2"
);
/**
 * Schedule editor template sample
 */
  ...
  const dataSource = {
    doctorsEventData: [
      ...
      },
      {
        ...
        Subject: "Programmation",
        Professor: "Saloua",
        StartTime: new Date(2021, 1, 16, 13, 0),
          ...
          <tr>
            ...
            <td colSpan={4}>
              <DropDownListComponent
                ...
                className="e-field"
                style={{ width: "100%" }}
                dataSource={["Analyse", "Programmation", "Java"]}
              />
            </td>
          </tr>
          <tr>
            ...
            <td colSpan={4}>
              <DropDownListComponent
                ...
                className="e-field"
                style={{ width: "100%" }}
                dataSource={["Sofienne", "Saloua", "Aymen"]}
              />
            </td>
          </tr>
          <tr>
            ...
            <div className="schedule-overview">
              ...
              <div className="toolbar">
                <ToolbarComponent
                  ...
                  scrollStep={100}
                  created={() =>
                    (liveTimeInterval = setInterval(() => {}, 1000))
                  }
