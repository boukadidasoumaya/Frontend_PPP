          ...
          <Card className="shadow">
            <CardHeader className="border-0 ">
              ...
              <div className="row d-flex select">
                <div className="col-lg-2 d-flex justify-end col-md-3 col-sm-12 select">
                  <SelectOptions
                  ...
                  />
                    ...
                    <div className="col-lg-2 d-flex  col-md-3  col-sm-12 select major ">
                  <SelectOptions
                  ...
                  />
                   ...
                   <div className="col-lg-2 d-flex justify-end col-md-4 col-sm-12 select">
                  <SelectOptions
